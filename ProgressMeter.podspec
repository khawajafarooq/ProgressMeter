#
# Be sure to run `pod lib lint ProgressMeter.podspec' to ensure this is a
...
Pod::Spec.new do |s|
  ...
  s.version          = '0.1.0'
  s.summary          = 'A short description of ProgressMeter.'
...
TODO: Add long description of the pod here.
  ...
  s.source_files = 'ProgressMeter/Classes/**/*'
  
  # s.resource_bundles = {
  #   'ProgressMeter' => ['ProgressMeter/Assets/*.png']
  # }
